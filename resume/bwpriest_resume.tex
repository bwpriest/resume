...
\item Evaluated the network-level efficacy of ``moving target'' computer network defenses against modeled adversaries using a multi-agent simulation platform of my design 
