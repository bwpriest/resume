...
\item[] \textit{Computation Student Intern}%
\hfill \textbf{April 2018 to September 2018 (Projected)}

\begin{innerlist}

\item Developed an efficient software kernel for massively parallel sampling of random walks from large distributed graphs
...
\item[] B.S.,
        \href{http://www.math.osu.edu/}
             {Mathematics}, \emph{Cum Laude}
	\hfill \textbf{September 2011 to June 2011}
%        \begin{innerlist}
...
\item[] B.S.,
        \href{http://www.cse.osu.edu/}
             {Computer and Information Science}, \emph{Cum Laude}
             \hfill \textbf{September 2011 to June 2011}
