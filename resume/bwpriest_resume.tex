...
\textbf{Languages}
\begin{innerlist}
\item[] C/C++, Python, Bash, MATLAB, R, Java
\end{innerlist}
\textbf{Computing}
\begin{innerlist}
\item[] Distributed and parallel algorithms
...
\textbf{Software}
\begin{innerlist}
\item[] Git, Keras and TensorFlow, most editors, \LaTeX{}
\end{innerlist}
\textbf{Interpersonal}
\begin{innerlist}
\item[] Teamwork and communication
\item[] Leadership and mentoring
\item[] Public speaking and technical communication
\end{innerlist}
%\textit{WWW:} \href{http://www.tedpavlic.com/}{www.tedpavlic.com}
}
...
\item Benjamin W. Priest, Roger Pearce, and Geoffrey Sanders.
DegreeSketch: Distributed Cardinality Sketches on Graphs, with Applications to Counting Triangles.
In \emph{Proceedings of the 2018 IEEE International Parallel and Distributed Processing Symposium}, IPDPS.
\textbf{[Submitted]}.
2019.
...
In \emph{Proceedings of the IEEE High Performance Extreme Computing Conference}, HPEC. 2018.
...
In \emph{Proceedings of the 15th International Conference on Security and Cryptography}, SECRYPT. 2018.
