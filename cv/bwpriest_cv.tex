...
%%---------------------------------------------------------------------------------------------------------
\input{components/research_experience_recent.tex}
\input{components/research_experience_old.tex}
\vspace{-0.5em}
...
\input{components/publications_old.tex}
\end{bibenum}
...
%	[\textbf{Submitted to Very Large Databases 2020}].
%	
...
%	[\textbf{Submitted to IEEE Transactions on Neural Networks and Learning Systems 2020}].
%	
%\end{bibenum}
%
%%%---------------------------------------------------------------------------------------------------------
...
\begin{bibenum}
\input{components/posters_conf.tex}
\end{bibenum}
